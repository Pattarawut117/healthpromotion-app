...
const newsList = [
  {
    ...
    description: "🏃🏻‍♀️เดินเฉยๆ มันธรรมดา…ต้องเดินแล้วได้รางวัลด้วย! มาเปลี่ยน “ทุกก้าว” ให้มีค่า กับแคมเปญ “Step Up Stronger ก้าวนี้ต้องแรงกว่าเดิม”👟🔥🗓️รับสมัคร 1-29 พฤษภาคม 69 นี้ แล้วมาก้าวไปด้วยกัน✨",
